...
> This file covers the rules behind the component. For a live, always-current view — rendered
> from the real component, not a screenshot — see [`/styleguide`](/styleguide)`#layout-structure-card`.
